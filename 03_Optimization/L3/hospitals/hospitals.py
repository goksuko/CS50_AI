...
# HILL-CLIMBING AND RANDOM RESTART FOR HOSPITAL PLACEMENT
...
class Space():
    ...
    def output_image(self, filename):
        ...
        house = Image.open(r"C:\Users\UTKU\Desktop\CS50_AI\03_Optimization\L3\hospitals\assets\images\House.png").resize(
            (cell_size, cell_size)
        )
        hospital = Image.open(r"C:\Users\UTKU\Desktop\CS50_AI\03_Optimization\L3\hospitals\assets\images\Hospital.png").resize(
            (cell_size, cell_size)
        )
        font = ImageFont.truetype(r"C:\Users\UTKU\Desktop\CS50_AI\03_Optimization\L3\hospitals\assets\fonts\OpenSans-Regular.ttf", 30)
        ...
        img.save(r"C:\Users\UTKU\Desktop\CS50_AI\03_Optimization\L3\hospitals\result_images" + "/" + filename)
